function Frame() {
  return (
    <div className="content-stretch flex gap-[4px] items-baseline relative shrink-0 z-[3]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#e8ebf0] text-[18px] whitespace-nowrap" style={{ fontFeatureSettings: "'fina', 'init'" }}>
        Bit Hydraulics
      </p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(191,201,212,0.7)] whitespace-nowrap" style={{ fontFeatureSettings: "'rclt' 0" }}>
        kg/m3
      </p>
...
export default function WidgetNumeralSimple() {
  return (
    <div className="content-stretch flex flex-col isolate items-start justify-center px-[6px] py-[4px] relative size-full" data-name="Widget / Numeral / Simple">
      <Frame />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[36px] not-italic relative shrink-0 text-[#a0ff8a] text-[28px] tracking-[-1px] whitespace-nowrap z-[2]">17,582.09</p>
